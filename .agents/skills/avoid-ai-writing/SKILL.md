...
license: MIT
metadata:
  compatibility: Any assistant supporting SKILL.md. No external tools or APIs required.
  version: "3.10.0"
...
2. **Edit in place**: apply minimal, targeted fixes to the flagged spans with the available file-editing tool, leaving already-human passages untouched
