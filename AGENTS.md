...
Evidence over theatre. Every material finding, classification, or claim links to a dated source. State uncertainty and failure modes. Where the track brief asks for a falsification criterion or a held-out evaluation, build for generalisation rather than the visible data.
